...
var tecla = [];
var colorBala = "yellow"; // Color de la bala
...
function Jugador(x){
    this.x = x;
    this.y = 450;
    this.w = 40; // Tamaño nave horizontal
    this.h = 25; // Tamaño nave vertical
...
//Selecte nave 
function myFunction() {
    var opc = prompt("Selecciona una Nave del 1 al 5");
    opc = Number(opc);
    switch(opc)
        {
            case 1:
                ...
                imagenEnemigo.src = "imagenes/Alien1.fw.png"; // Cambio de marcianos
                imagen.src = "imagenes/torre1.fw.png"; // Cambio de nave
                intro.play();
            ...
            case 2:
                imagen = new Image();
                imagenEnemigo = new Image();
                imagenEnemigo.src = "imagenes/Alien2.fw.png"; // Cambio de marcianos
                imagen.src = "imagenes/torre2.fw.png"; // Cambio de nave
                intro.play();
                imagen.onload = function(){
                jugador = new Jugador(0);
                setTimeout(anima,1000);
            ...
            case 3:
                ...
                imagenEnemigo = new Image();
                imagenEnemigo.src = "imagenes/Alien1.fw.png"; // Cambio de marcianos
                imagen.src = "imagenes/torre3.fw.png"; // Cambio de nave
                intro.play();
                imagen.onload = function(){
                jugador = new Jugador(0);
                setTimeout(anima,1000);
            ...
            case 4:
                ...
                imagenEnemigo = new Image();
                imagenEnemigo.src = "imagenes/Alien2.fw.png"; // Cambio de marcianos
                imagen.src = "imagenes/torre4.fw.png"; // Cambio de nave
                intro.play();
                imagen.onload = function(){
                jugador = new Jugador(0);
                setTimeout(anima,1000);
            ...
            case 5:
                ...
                imagenEnemigo = new Image();
                imagenEnemigo.src = "imagenes/Alien1.fw.png"; // Cambio de marcianos
                imagen.src = "imagenes/torre5.fw.png"; // Cambio de nave
                intro.play();
                imagen.onload = function(){
                jugador = new Jugador(0);
                setTimeout(anima,1000);
